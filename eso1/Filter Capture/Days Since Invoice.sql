SELECT
  ...
  CASE
    ...
    ELSE (TO_DATE (N'01/01/2026', N'dd/mm/yyyy') + 190) - (
      TO_DATE (
        N'01/01/' || TO_CHAR (FLOOR(TO_NUMBER (MAX(F4211.SDIVD) / 1000)) + 1900),
        N'dd/mm/yyyy'
      ) + MAX(F4211.SDIVD) - FLOOR(TO_NUMBER (MAX(F4211.SDIVD) / 1000)) * 1000 - 1
    )
...
FROM
  ...
  ) F0101 ON F4211.SDAN8 = F0101.ABAN8
WHERE
  (
    ((F4211.SDKCOO IN (N'00750')))
