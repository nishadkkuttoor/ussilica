SELECT F4211.SDMCU                        F4211_SDMCU,
       ...
       126223                             ID_CUSTOM_8f246e4cdf0ee6,
       ...
       SUM(CASE
           ...
           END)                           ReportColumn13,
       SUM(CASE
             WHEN F4211.SDDRQJ = 126225 THEN F4211.SDUORG
           END)                           ReportColumn14,
       SUM(CASE
             WHEN F4211.SDDRQJ = 126225 THEN 1
             ELSE 0
           END)                           ReportColumn15,
       SUM(CASE
             WHEN F4211.SDDRQJ BETWEEN 126226 AND 126228 THEN F4211.SDUORG
           END)                           ReportColumn16,
       SUM(CASE
             WHEN F4211.SDDRQJ BETWEEN 126226 AND 126228 THEN 1
             ELSE 0
           END)                           ReportColumn17,
       SUM(CASE
             WHEN F4211.SDDRQJ BETWEEN 126229 AND 126237 THEN F4211.SDUORG
           END)                           ReportColumn18,
       SUM(CASE
             WHEN F4211.SDDRQJ BETWEEN 126229 AND 126237 THEN 1
             ELSE 0
           END)                           ReportColumn19,
       SUM(CASE
             WHEN F4211.SDDRQJ = 126238 THEN F4211.SDUORG
           END)                           ReportColumn20,
       SUM(CASE
             WHEN F4211.SDDRQJ = 126238 THEN 1
             ELSE 0
           END)                           ReportColumn21,
...
WHERE  ( (( (( (( (( (( (( F4211.SDLTTR  N'980' ))
                        AND (( F4211.SDDCTO IN ( N'SO' ) )) ))
                     AND (( ( NOT ( NVL(RTRIM(LTRIM(F4211.SDLITM)), N' ') LIKE N'MISC%' ) )
                            AND ( NOT ( NVL(RTRIM(LTRIM(F4211.SDLITM)), N' ') LIKE N'TR%' ) ) )) ))
                  AND (( F4211.SDNXTR IN ( N'560' ) )) ))
               AND (( NOT ( F4211.SDLNTY IN ( N'F ', N'FT' ) ) )) ))
            AND (( F4211.SDVR01 IN ( N'NPO                      ' ) )) ))
         AND (( F0101.ABSIC IN ( N'F         ', N'FA        ', N'FB        ' ) )) )
GROUP  BY F4211.SDMCU,
          F4211.SDADDJ,
          F4211.SDDRQJ,
          F4201.SHOPDJ,
          F4211.SDCNDJ,
