]SELECT RawF4211.XF4211_SDTRDJ               F4211_SDTRDJ,
...
FROM   (SELECT DISTINCT F4211.SDTRDJ                                                         XF4211_SDTRDJ,
        ...
        FROM   PRODDTA.F4211 F4211
               LEFT JOIN PRODDTA.F0116 F0116
                 ON F4211.SDSHAN = F0116.ALAN8
        WHERE  ( (( (( (( NOT ( F4211.SDLTTR IN ( N'980' ) ) ))
                       AND (( F4211.SDNXTR BETWEEN N'525' AND N'573' )) ))
                    AND (( F4211.SDLNTY IN ( N'S ' ) )) ))
                 AND (( F4211.SDPA8 IN ( 20022190 ) )) )) RawF4211
GROUP  BY RawF4211.XF4211_SDTRDJ,
