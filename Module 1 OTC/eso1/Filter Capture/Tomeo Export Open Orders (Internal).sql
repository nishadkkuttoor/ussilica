SELECT RawF4211.XC_F4211_SDMCU              C_F4211_SDMCU,
       ...
       RawF4211.XF5642B01_BA55BKSTAT        F5642B01_BA55BKSTAT,
...
FROM   (SELECT DISTINCT F4211.SDMCU                                                          XC_F4211_SDMCU,
                        ...
                        F5642B01.BA55BKSTAT                                                  XF5642B01_BA55BKSTAT,
        ...
        FROM   PRODDTA.F4211 F4211
               ...
               LEFT JOIN PRODDTA.F5642B01 F5642B01
                         INNER JOIN (SELECT F0101.ABALPH,
                           ...
                           ON F5642B01.BA55OCCR = F0101.ABAN8
                 ON ( F4211.SDDOCO = F5642B01.BADOCO )
                    AND ( F4211.SDSHPN = F5642B01.BASHPN )
               LEFT JOIN PRODDTA.F5642B11 F5642B11
                 ON ( ( ( ( F4211.SDKCOO = F5642B11.AKKCOO )
        ...
        WHERE  ( (( (( (( (( NOT ( F4211.SDNXTR IN ( N'999' ) ) ))
                          AND (( NOT ( F4211.SDLTTR IN ( N'980' ) ) )) ))
                       AND (( F4211.SDLNTY IN ( N'S ' ) )) ))
                    AND (( F4211.SDSHAN IN ( 20022809, 20016204, 20022812 ) )) ))
                 AND (( F4211.SDPA8 IN ( 20022627 ) )) )) RawF4211
GROUP  BY RawF4211.XC_F4211_SDMCU,
