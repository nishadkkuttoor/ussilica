...
# Builds and continuously refreshes ONE table — `lh_jde_gold.rpt.dim_item` — from the
...
# ── Silver sources ────────────────────────────────────────────────────────────
SILVER_SCHEMA    = "jde" # Silver schema for ESO1 (F4101 exposed here by the user); CDF-enabled.
                          #   `jde` (2026-07-26, was `jde_cdc`) — same as ESO4/ESO5. CDF on F4101.
