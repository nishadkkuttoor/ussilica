...
# The tons rate/values themselves are computed in the semantic-model measures from the dims, NOT stored here.
...
FACT_BUSINESS_COLS = [
    ...
    "missing_conversion_flag", "item_uom_key",   # flag = no item UoM->TN row; item_uom_key -> dim (tons factor in measures)
